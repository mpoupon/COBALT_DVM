...
! CAS: Added diagnostic for diatom NPP in top 100m for CMIP
    ...
    vardesc_temp = vardesc("jzloss_nvmmdz_100","Vertically migrating medium zooplankton nitrogen loss to zooplankton integral in upper 100m",'h','1','s','mol m-2 s-1','f')
    ...
    vardesc_temp = vardesc("jprod_ndet_nvmlgz_100","Vertically migrating large zooplankton nitrogen detritus prod. integral in upper 100m",'h','1','s','mol m-2 s-1','f')
...
!==============================================================================================================
  ...
  subroutine user_add_params
    ...
    !   Effect is to decrease alkalinity by 1.996 NH4 equivalents (close enough to 2).
    !
    ! Denitrification:
...
!    call g_tracer_add_param('o2_2_nfix', cobalt%o2_2_nfix, (118.0+3.0/(5.0+3.0)*(150.0-118.0))/16.0) ! mol O2 mol N-1
    ...
    call g_tracer_add_param('nswitch_vmmdz',zoo(4)%nswitch, 2.0)          ! dimensionless
    call g_tracer_add_param('nswitch_vmlgz',zoo(5)%nswitch, 2.0)          ! dimensionless
    ...
    call g_tracer_add_param('mswitch_vmlgz',zoo(5)%mswitch, 2.0)          ! dimensionless
    ...
    call g_tracer_add_param('lgz_ipa_vmmdz',zoo(3)%ipa_vmmdz, 1.0)         ! dimensionless
    ...
    call g_tracer_add_param('vmmdz_ipa_smz',zoo(4)%ipa_smz, 1.0)         ! dimensionless
    call g_tracer_add_param('vmmdz_ipa_mdz',zoo(4)%ipa_mdz, 0.0)         ! dimensionless
    ...
    call g_tracer_add_param('vmlgz_ipa_vmmdz',zoo(5)%ipa_vmmdz, 1.0)         ! dimensionless
